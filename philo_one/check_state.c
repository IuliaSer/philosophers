...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/16 20:12:02 by iserzhan          #+#    #+#             */
/*   Updated: 2021/01/22 12:44:33 by iserzhan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	check_for_death(t_all *all, int i)
{
	...
	{
		pthread_mutex_lock(&all->phil->data->write_lock);
		g_alive = 0;
...
static int	check_if_eatten_enough(t_all *all, unsigned int count)
{
	...
	{
		pthread_mutex_lock(&all->data->write_lock);
